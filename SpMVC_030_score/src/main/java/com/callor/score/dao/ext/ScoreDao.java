...
public interface ScoreDao extends GenericDao<ScoreVO, Long>{
	...
	/*
	 * mybatis 에서 SQL select의 결과가 숫자일 경우 resultType으로 wrapper class를 지정한다
	 * int : Integer
	 * long : Long
	 * 
	 * 문자열일 경우 resultType을 String 으로 지정한다
	 * String : String
	 * 
	 * Dao Method의 return type도 Wrpper class type으로 지정
	 */
