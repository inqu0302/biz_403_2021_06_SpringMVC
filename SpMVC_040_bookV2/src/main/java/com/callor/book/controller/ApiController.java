 ...
 * RestFull Service
 * API Service
 * Request 에 대하여 view(*.jpg, *.html)등을 보여주지 않고 약속된 데이터를 Response하는 서비스
 * 
...
public class ApiController {
	...
	/*
	 * Ajax를 통해서 정송되어온 데이터 받기
	 * Ajax에 POST로 전송된 데이터는 Request의 body(PayLoad)에 담겨서 전달되어 온다
	 * 일반적인 JSP(form, link)에서 보낸 데이터는 매개변수를 통하여 
	 * 직접 전달 받을 수 있는데 Ajax를 통하여 받은 데이터는 그렇지 못하다
